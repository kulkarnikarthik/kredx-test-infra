...
public class WalletCreditTest extends BaseTest {
    ...
    public void alphanumericTopupInputTest(){
        ...
        manageFundsPage.goToManageFundsPage()
                       ...
                       .clickOnNetbankingOption();
        Assert.assertEquals(manageFundsPage.errorMessageOnInvalidInputAmount(),data.getInvalidInputErrorMessage(),"No validation for alphanumeric input");
        dashboardPage.logoutUser();
    }
    ...
    public void EmptyTopupFieldTest(){
        ...
        manageFundsPage.goToManageFundsPage()
                .clickOnAddFundsButton()
                .clickOnNetbankingOption();
        Assert.assertEquals(manageFundsPage.errorMessageOnInvalidInputAmount(),data.getInvalidInputErrorMessage(),"No validation for empty input");
